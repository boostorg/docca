...
/// The MutableBufferSequence used to represent the writable bytes.
    ...
    */
    basic_issue_50() noexcept(default_nothrow);
    ...
    */
    explicit
    basic_issue_50(Allocator const& alloc) noexcept;
    ...
    */
    ...
    /** Move Constructor
        ...
        No-throw guarantee.
    */
    basic_issue_50(basic_issue_50&& other) noexcept;
    ...
    */
    basic_issue_50(basic_issue_50 const& other);
    ...
    */
    template<class OtherAlloc>
    basic_issue_50(
    basic_issue_50<OtherAlloc> const& other,
    ...
    */
    ...
    /** Copy Assignment
        ...
        maximum allocation size of the allocator.
    */
    basic_issue_50& operator=(
    basic_issue_50 const& other);
    ...
    */
    ...
    void
    swap(
    basic_issue_50<Alloc>& lhs,
    basic_issue_50<Alloc>& rhs) noexcept;
...
private:
    template<class OtherAlloc>
    friend class basic_issue_50;

    template<class OtherAlloc>
    void copy_from(basic_issue_50<OtherAlloc> const&);
    void move_assign(basic_issue_50& other, std::false_type);
    void move_assign(basic_issue_50& other, std::true_type) noexcept;
    void copy_assign(basic_issue_50 const& other, std::false_type);
    void copy_assign(basic_issue_50 const& other, std::true_type);
    void swap(basic_issue_50&) noexcept;
    void swap(basic_issue_50&, std::true_type) noexcept;
    void swap(basic_issue_50&, std::false_type) noexcept;
